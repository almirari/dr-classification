...
try:
    ...
    SCRIPT_DIR = Path(r'D:\UNI\TUGAS-AKHIR\code\dr-classification\05_results')
...
STUDENT_SCENARIOS = [
    {
        'name':        'Multi-Teacher KD — Nominal CE  (ResNet-50-CE + EffNetB3-CE → MobileNetV3-Small)',
        'short':       'multi_nominal_resnet50_effnetb3',
        'notebook':    'mkd_ce_resnet50_efficientnetb3.ipynb',
        'model_dir':   _MULTI / 'nominal_resnet50_effnetb3',
        'ckpt_prefix': 'kd',                   # kd_seed{seed}_best.pth
    },
    {
        'name':        'Multi-Teacher KD — Ordinal CORAL  (ResNet-50-CORAL + EffNetB3-CORAL → MobileNetV3-Small)',
        'short':       'multi_ordinal_resnet50_effnetb3',
        'notebook':    'mkd_coral_resnet50_efficientnetb3.ipynb',
        'model_dir':   _MULTI / 'ordinal_resnet50_effnetb3',
    ...
    },
    {
        ...
        'ckpt_prefix': 'hybridresnet50_camkd', # hybridresnet50_camkd_seed{seed}_best.pth
    },
]

TEACHER_SCENARIOS = [
    {
        'name':     'Teacher — ResNet-50-CE  (nominal CE)',
        'short':    'teacher_nominal_resnet50_ce',
        'notebook': 'mkd_ce_resnet50_efficientnetb3.ipynb',
        'ckpt':     _MULTI / 'nominal_resnet50_effnetb3' / 'kd_teacher_resnet50.pth',
    },
    {
        'name':     'Teacher — EfficientNetB3-CE  (nominal CE)',
        'short':    'teacher_nominal_effnetb3_ce',
        'notebook': 'mkd_ce_resnet50_efficientnetb3.ipynb',
        'ckpt':     _MULTI / 'nominal_resnet50_effnetb3' / 'kd_teacher_efficientnet_b3.pth',
    },
    {
        'name':     'Teacher — ResNet-50-CORAL  (ordinal CORAL)',
        'short':    'teacher_ordinal_resnet50_coral',
        'notebook': 'mkd_coral_resnet50_efficientnetb3.ipynb',
        'ckpt':     _MULTI / 'ordinal_resnet50_effnetb3' / 'coral_kd_teacher_resnet50.pth',
    },
    {
        'name':     'Teacher — EfficientNetB3-CORAL  (ordinal CORAL)',
        'short':    'teacher_ordinal_effnetb3_coral',
        'notebook': 'mkd_coral_resnet50_efficientnetb3.ipynb',
        'ckpt':     _MULTI / 'ordinal_resnet50_effnetb3' / 'coral_kd_teacher_efficientnet_b3.pth',
    },
    {
        'name':     'Teacher — ResNet-50-CE  (hybrid resnet50+effnetb3)',
        'short':    'teacher_hybrid_re_resnet50_ce',
        'notebook': 'mkd_hybrid_resnet50_efficientnetb3.ipynb',
    ...
    },
    {
        ...
        'short':    'teacher_hybrid_re_effnetb3_coral',
        'notebook': 'mkd_hybrid_resnet50_efficientnetb3.ipynb',
        'ckpt':     _MULTI / 'hybrid_resnet50_effnetb3' / 'hyrid_teacher_efficientnet_coral.pth',
    },
    {
        'name':     'Teacher — ResNet-50-CE  (hybrid resnet50+resnet50)',
        'short':    'teacher_hybrid_rr_resnet50_ce',
        'notebook': 'mkd_hybrid_resnet50_resnet50.ipynb',
        'ckpt':     _MULTI / 'hybrid_resnet50_resnet50' / 'hybrid_teacher_resnet50_ce.pth',
    },
    {
        'name':     'Teacher — ResNet-50-CORAL  (hybrid resnet50+resnet50)',
        'short':    'teacher_hybrid_rr_resnet50_coral',
        'notebook': 'mkd_hybrid_resnet50_resnet50.ipynb',
...
BATCH_SIZE  = 32
# Kept on CPU for ALL scenarios (students + teachers) so latency / memory
# numbers are directly comparable across architectures. Do not switch to
# CUDA here unless you also re-measure every other script on the same device.
...
def format_summary(summary_rows, title):
    ...
    for i, row in enumerate(sorted(summary_rows,
        ...
        lines.append(
            f"  {i:<3} {row['scenario']:<32} {np.mean(row['params_m']):>10.3f} "
